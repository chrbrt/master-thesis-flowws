...
\subsection{Visuelle Richtlinien}
Das visuelle Design von orientiert sich primär an dem von Google vorgestellten \textit{Material Design}. Durch gezielte Benutzung von Schatten, Formen und Animationen, bietet es eine klare Sichtweise die in physischen Metaphern geerdet ist, an.

In Abbildung \ref{Kap3} 
\begin{itemize}
    \item Farben, Formen und Symbole geben Aufschlüsse für Funktionalität und Daten  
    \item Dynamik innerhalb des Systems mit kurzen prägnanten Animationen darstellen
    \item 
\end{itemize}
